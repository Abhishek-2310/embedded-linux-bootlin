/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/abhi/Embedded_Linux_ws/embedded-linux-bbb-labs/toolchain/crosstool-ng/.build/arm-training-linux-musleabihf/src/gcc/gcc/config/arm/arm.md'.  */
